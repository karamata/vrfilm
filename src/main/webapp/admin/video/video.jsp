        ...
        <form method="POST" enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" name="movieName" class="form-control" id="movieName" placeholder="<s:property value="getText('film.name')"/>">
            </div>
            <div class="form-group">
          ...
          <div class="box-footer">
            <input type="submit" name="submitType" value="<s:property value="getText('add.video')"/>" class="btn btn-primary">
                    ...
                    <tbody>
                    	<s:iterator value="listMovie">
	                      <tr>
	                        ...
	                        <td><a class="label label-danger" href="/movie/<s:property value="movieId"/>/delete"><s:property value="getText('delete.title')"/></a></td>
	                      </tr>
                      </s:iterator>
                    </tbody>
                    <tfoot>
